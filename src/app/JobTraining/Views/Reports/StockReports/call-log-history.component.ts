...
// define component
@Component({
  selector: 'jobtraining-report-call-log-history-component',
  templateUrl: 'call-log-history.component.html',
  styleUrls: [
    '../../../page.scss'
  ]
})
...
export class Reporting_CallLogHistoryComponent implements OnInit {
  ...
  *******************************************/
  public onCloseReportClick() {
    ...
    baseUrl = this.router.url.split('/callloghistory')[0];
  ...
  *******************************************/
  ...
  private _getReport() {
    this.jobTrainingService.getCallLogHistory(
