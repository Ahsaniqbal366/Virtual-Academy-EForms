...
@Component({
  selector: 'app-admin-available-forms',
  templateUrl: './admin-available-forms.component.html',
  styleUrls: ['./admin-available-forms.component.scss'],
})
export class AdminAvailableFormsComponent  implements OnInit, AfterViewInit {
