...
import { ReportTypeInfo } from 'src/app/Reporting/Providers/reporting.model';

// define component
@Component({
    selector: 'report-result-bycourse',
    templateUrl: 'report-result-bycourse.component.html',
    styleUrls: ['../../../reporting.page.scss'],

})

// create class for export
export class ReportingResultByCourse implements OnInit {
    ...
    public reportSortChange(sort: Sort) {
        ...
        this.reportTableDataSource.data = data.sort((a, b) => {
            ...
            switch (sort.active) {
                ...
                case 'GroupName':
                    return this._filterPipe.compare(a.GroupName, b.GroupName, isAsc);
                case 'Rank':
